...
def Expandterritory0():
    if loadmap[et[0][1]][et[0][0]]==0 and et[0][0]!=0 and et[0][0]!=9 and et[0][1]!=0 and et[0][1]!=9:
        for i in range(0,3):
            for j in range(0,3):
...
def Expandterritorymines():
    ...
    for i in range(0,3):
        for j in range(0,3):
            if minesmap[et[0][1]-1+i][et[0][0]-1+j]=='Tbanner' and et[0][0]!=0 and et[0][0]!=9 and et[0][1]!=0 and et[0][1]!=9:
                etmines-=1
            if minesmap[et[0][1]-1+i][et[0][0]-1+j]=='Fbanner' and et[0][0]!=0 and et[0][0]!=9 and et[0][1]!=0 and et[0][1]!=9:
                etmines+=9
    if etmines==0:
        for i in range(0,3):
            for j in range(0,3):
...
for i in range(len(minesx)):
    ...
    if minesx[i]==0:                                            #第1種可能
        if minesy[i]!=0 and minesy[i]!=9:                       #第1-1種可能
            for j in range(1,3):
                for k in range(0,3):
                    loadmap[minesy[i]-1+k][minesx[i]-1+j]+=1
