...
def scoring():
    ...
    f.writelines(name.get+'總用時長',labtime['text'])
    f.close
...
lab1=tk.Label(text='玩家姓名:',font=('微軟正黑體',19,'bold'),fg='brown',bg='grey')
lab1.place(x=610,y=35)

name=tk.StringVar()
textbox=tk.Entry(textvariable=name,width=20,)#產生一個可以輸入文字的(文字盒)
textbox.place(x=730,y=35)


lab0=tk.Label(text='請選擇難度!',font=('微軟正黑體',19,'bold'),fg='brown',bg='lightgreen')
lab0.place(x=680,y=700)
