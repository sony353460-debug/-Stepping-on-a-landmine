...
def rank():
    ...
    #遊戲說明
    mylabel1.place(x=200,y=325) 
    mylabel2.place(x=200,y=350) 
    mylabel3.place(x=200,y=375) 
    mylabel4.place(x=200,y=400) 
    mylabel5.place(x=200,y=450) 
    mylabel6.place(x=200,y=475) 
    mylabel7.place(x=200,y=500) 
    mylabel8.place(x=200,y=525) 
    mylabel9.place(x=200,y=550) 
    mylabel10.place(x=200,y=575) 
    mylabel11.place(x=200,y=600) 
    #鍵盤示意圖
    ...
    lab0.place(x=750,y=385)
    textbox.place(x=870,y=395)
    btn.place(x=840,y=500)
    list1.place(x=1070,y=300)
...
#遊戲說明
mylabel0=tk.Label(form, text='踩地雷規則:',bg='lightgreen')
mylabel1=tk.Label(form, text='踩地雷難度分為初級、中級、高級，初級的格子數為9*9、地雷數為10顆',bg='lightgreen')
mylabel2=tk.Label(form, text='中級的格子數為16*16、地雷數為40顆，高級的格子數為30*16、地雷數',bg='lightgreen')
mylabel3=tk.Label(form, text='為99顆，要將所有地雷用旗幟標誌出來即可完成遊戲，挖到地雷時則失敗',bg='lightgreen')
mylabel4=tk.Label(form, text='並結束遊戲。',bg='lightgreen')
mylabel5=tk.Label(form, text='遊戲按鍵:',bg='lightgreen')
mylabel6=tk.Label(form, text='按鍵盤W向上走',bg='lightgreen')
mylabel7=tk.Label(form, text='按鍵盤A向左走',bg='lightgreen')
mylabel8=tk.Label(form, text='按鍵盤S向左走',bg='lightgreen')
mylabel9=tk.Label(form, text='按鍵盤D向左走',bg='lightgreen')
mylabel10=tk.Label(form, text='按鍵盤E挖開格子',bg='lightgreen')
mylabel11=tk.Label(form, text='按鍵盤Q插上旗幟',bg='lightgreen')
mylabel0.place(x=200,y=300) 
