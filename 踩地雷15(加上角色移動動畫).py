...
def player_walk():
    global x,y,et,c,counts,c1,c2,walkabove,walkunder,walkleft,walkright
    if key=='w':#向上走
        y-=1
...
def rank():
    ...
    mylabel5.place(x=100,y=420) 
    mylabel6.place(x=100,y=475) 
    mylabel7.place(x=100,y=505) 
    mylabel8.place(x=100,y=535) 
    mylabel9.place(x=100,y=565) 
    mylabel10.place(x=100,y=595) 
    mylabel11.place(x=100,y=625) 
    #鍵盤示意圖
    cvs.create_image(475,425,image=keyboard,anchor='nw',tag='tag_keyboard')
...
#紀錄文字盒輸入的資料
scrollbar = tk.Scrollbar(form)         # 在頁框中加入捲軸元件
scrollbar.pack(side='right', fill='y')  # 設定捲軸的位置以及填滿方式
list1=tk.Listbox(width=20,height=20,font=('微軟正黑體',14,'bold'),fg='blue',yscrollcommand=scrollbar.set)

#遊戲說明
mylabel0=tk.Label(form, text='踩地雷規則:',font=('微軟正黑體',30,'bold'),bg='lightgreen')
mylabel1=tk.Label(form, text='踩地雷難度分為初級、中級、高級，初級的格子數為9*9、地雷數為10顆',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel2=tk.Label(form, text='中級的格子數為16*16、地雷數為40顆，高級的格子數為30*16、地雷數',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel3=tk.Label(form, text='為99顆，要將所有地雷用旗幟標誌出來即可完成遊戲，挖到地雷時則失敗',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel4=tk.Label(form, text='並結束遊戲。',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel5=tk.Label(form, text='遊戲按鍵:',font=('微軟正黑體',30,'bold'),bg='lightgreen')
mylabel6=tk.Label(form, text='按鍵盤W向上走',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel7=tk.Label(form, text='按鍵盤A向左走',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel8=tk.Label(form, text='按鍵盤S向左走',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel9=tk.Label(form, text='按鍵盤D向左走',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel10=tk.Label(form, text='按鍵盤E挖開格子',font=('微軟正黑體',15,'bold'),bg='lightgreen')
mylabel11=tk.Label(form, text='按鍵盤Q插上旗幟',font=('微軟正黑體',15,'bold'),bg='lightgreen')
